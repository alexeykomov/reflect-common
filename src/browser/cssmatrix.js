...
!('CSSMatrix' in goog.global) && (function() {
  ...
  class CSSMatrix {
     ...
     */
    scale(opt_scaleX, opt_scaleY, opt_scaleZ) {
      var x = opt_scaleX;
      var y = opt_scaleY;
      var z = opt_scaleY;
     ...
     */
    rotate(opt_rotX, opt_rotY, opt_rotZ) {
      var rx = opt_rotX || 0;
      var ry = opt_rotY || 0;
      var rz = opt_rotZ;
     ...
     */
    rotateAxisAngle(opt_x, opt_y, opt_z, opt_angle) {
      var x = opt_x || 0;
      var y = opt_y || 0;
      var z = opt_z || 0;
  ...
  //Exporting.
  goog.exportSymbol('CSSMatrix', CSSMatrix);
